...
-- MODIFIÉ POUR AIVEN MySQL (clés primaires dans CREATE TABLE)
...
CREATE TABLE `Orders` (
  ...
  KEY `order_restaurant_id` (`restaurant_id`)
...
CREATE TABLE `Products` (
  ...
  KEY `product_restaurant_id` (`restaurant_id`)
...
CREATE TABLE `Product_has_allergens` (
  ...
  KEY `allergens_allergen_id` (`allergen_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
